...
INSERT INTO `fablab`.`t_event_person` (`event_person_id`, `firstname`, `lastname`, `email`, `active`) VALUES (14, 'Franck', 'Vallat', 'franck.vallat@fablabmanager.ch', 1);
INSERT INTO `fablab`.`t_event_person` (`event_person_id`, `firstname`, `lastname`, `email`, `active`) VALUES (15, 'Antoine', 'Aebi', 'admin@fablabmanager.ch', 1);
INSERT INTO `fablab`.`t_event_person` (`event_person_id`, `firstname`, `lastname`, `email`, `active`) VALUES (16, 'Mathias', 'Mercier', 'mathias.mercier@fablabmanager.ch', 1);
INSERT INTO `fablab`.`t_event_person` (`event_person_id`, `firstname`, `lastname`, `email`, `active`) VALUES (17, 'Christian', 'Chopard', 'christian.chopard@fablabmanager.ch', 1);
