...
public class MachineStatusWS extends ReadWriteRestWebservice<MachineStatusEO, MachineStatusService> implements SoftRemoveWebService {
    ...
    public void softRemove(Integer id) throws FablabException {
        machineStatusService.softRemove(id);
    }
}
