...
public class SupplyUnityWS extends ReadWriteRestWebservice<SupplyUnityEO, SupplyUnityService> implements SoftRemoveWebService {
    ...
    public void softRemove(Integer id) throws FablabException {
        supplyUnityService.softRemove(id);
    }
}
